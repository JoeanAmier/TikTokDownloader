...
|          `https://www.douyin.com/note/数字`          |    图集    | 永久有效 |   单独下载    |
|         `https://www.douyin.com/video/数字`          |    视频    | 永久有效 |   单独下载    |
|       `https://www.douyin.com/user/字母数字符号组合`       |    账号    | 永久有效 |   批量下载    |
| `https://www.douyin.com/user/字母数字符号组合?modal_id=数字` | 账号、视频、图集 | 永久有效 | 批量下载、单独下载 |
