...
class ABogus:
    ...
    def generate_string_2_list(
        ...
        ua_code = [  # 暂时固定
            184, 135, 117, 109, 27, 119, 230, 10,
            182, 76, 86, 203, 86, 58, 192, 40,
            12, 140, 71, 6, 85, 167, 45, 75,
            54, 234, 45, 146, 182, 25, 38, 217
        ]
        # ua_code = [
        #     70, 169, 192, 148, 108, 72, 7,
        #     61, 100, 249, 178, 111, 172, 223,
        #     214, 48, 161, 244, 177, 184, 84,
        #     102, 206, 117, 172, 122, 199, 96,
        #     79, 171, 26, 182
        # ]
        return self.list_4(
            (end_time >> 24) & 255,
